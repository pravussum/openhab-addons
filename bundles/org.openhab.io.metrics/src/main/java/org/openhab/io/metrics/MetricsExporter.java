...
public abstract class MetricsExporter {
    ...
    abstract protected void start(CompositeMeterRegistry meterRegistry, MetricsConfiguration metricsConfiguration);

    abstract protected void shutdown();

    abstract protected boolean isEnabled(MetricsConfiguration config);
